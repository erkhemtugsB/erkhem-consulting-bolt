...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center bg-blue-900 overflow-hidden">
      {/* Spline Background */}
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="max-w-2xl">
          <div className="flex items-center space-x-2">
            ...
            <p className="text-blue-300 font-medium">Web Development Consulting</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8">
            <a 
              href="#contact" 
              className="px-8 py-4 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-all flex items-center justify-center group"
            >
              Get Started
            ...
            <a 
              href="#portfolio" 
              className="px-8 py-4 bg-transparent border border-blue-300 text-white font-medium rounded-lg hover:bg-blue-800/30 transition-all flex items-center justify-center"
            >
              View Our Work
            </a>
          </div>
