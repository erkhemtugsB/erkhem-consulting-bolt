        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-4">
              <Code className="h-8 w-8 text-indigo-400 mr-2" strokeWidth={2.5} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">Custom Web Development</a></li>
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">UI/UX Design</a></li>
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">E-commerce Solutions</a></li>
              <li><a href="#" className="text-gray-400 hover:text-indigo-400 transition-colors">Digital Strategy</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#portfolio" className="text-gray-400 hover:text-indigo-400 transition-colors">Portfolio</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe to our newsletter to receive updates and insights on web development.
            </p>
