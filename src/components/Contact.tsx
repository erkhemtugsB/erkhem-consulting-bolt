        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="col-span-1 space-y-6">
            <div className="flex items-start space-x-4">
              <div className="bg-navy-100 p-3 rounded-lg text-navy-600">
          ...
          <div className="col-span-1 lg:col-span-2">
            <form onSubmit={handleSubmit} className="bg-gray-50 p-8 rounded-xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-navy-600 focus:border-navy-600"
              ...
              <button
                type="submit"
                className="w-full px-6 py-4 bg-navy-600 text-white font-medium rounded-lg hover:bg-navy-700 transition-colors flex items-center justify-center gap-2"
              >
