...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-20 bg-indigo-900 text-white">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Client Testimonials</h2>
          <div className="h-1 w-24 bg-indigo-400 mx-auto mb-6"></div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            <div className="bg-indigo-800/50 backdrop-blur-sm rounded-2xl p-8 md:p-12">
              <Quote className="h-12 w-12 text-indigo-400 mb-6 opacity-50" />
              
              <div className="mb-8">
                <p className="text-xl md:text-2xl italic text-indigo-100 mb-8">
                  ...
                  {testimonials.map((_, index) => (
                    <button
                      ...
                      className={`w-2.5 h-2.5 rounded-full transition-all ${
                        index === currentIndex ? 'bg-indigo-400 w-8' : 'bg-indigo-600'
                      }`}
